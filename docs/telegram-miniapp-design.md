...
## Navigation
- Bottom tabs: `Wallets`, `Address Book`, `AML`.
...
- Primary actions: refresh balances, refresh transactions, remove duplicates.
- Transaction feed supports filters for small USDT, TRX, and own fund transfers.
